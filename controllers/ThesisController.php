...
class ThesisController {
    ...
    public function create() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            // Create thesis record - Fixed parameter order
            $result = $this->thesisModel->create($user_id, $title, $abstract, $dbPath, 'submitted');
    ...
    public function show() {
        ...
        // Prepare data for view - add asset() to file_path for proper URL
        $thesis['author'] = $thesis['author_name'] ?? 'Unknown';
        $thesis['file_path'] = asset($thesis['file_path']);
